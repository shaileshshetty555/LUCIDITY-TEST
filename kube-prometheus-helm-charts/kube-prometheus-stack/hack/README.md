...
./hack/update_mixins.sh
```

## Validation Commands

```bash
python3 hack/sync_prometheus_rules.py --help
python3 hack/sync_grafana_dashboards.py --help
```
...
```bash
git status
ls -la templates/prometheus templates/grafana
```
